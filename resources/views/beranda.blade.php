...
<body class="bg-light">
    ...
    <div class="container py-5 text-center">
        ...
        <p class="lead">Kami menyediakan layanan bimbingan belajar profesional untuk SD, SMP, dan SMA.</p>
    ...
    <div class="row px-4">
        ...
        <div class="col-lg-4">
            <div class="p-3 bg-white shadow-sm rounded">
                <div class="d-flex align-items-center">
                    ...
                    <img src="{{ $youtubefotoProfile }}" width="80" height="80" class="rounded-circle ms-auto">
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="p-3 bg-white shadow-sm rounded">
                ...
                @php 
                    $latesVideoId = $resultLatest['items'][0]['id']['videoId'] ?? null;
                @endphp
                ...
                @if($latesVideoId)
                    <iframe 
                        width="100%" 
                        height="400" 
                        src="https://www.youtube.com/embed/{{ $latesVideoId }}" 
                        frameborder="0" 
                        allowfullscreen>
                    </iframe>
                @else
                    <p class="text-danger text-center">Tidak dapat memuat video terbaru.</p>
                @endif
